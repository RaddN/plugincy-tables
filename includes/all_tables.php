                        ...
                        <tbody>
                            <?php foreach ($tables as $table): ?>
                                <tr>
                                    ...
                                    <td>
                                        <code>[plugincy_table id="<?php echo esc_attr($table->id); ?>"]</code>
                                        <button type="button" class="button button-small copy-shortcode" data-shortcode="[plugincy_table id=&quot;<?php echo esc_attr($table->id); ?>&quot;]">Copy</button>
                                    </td>
